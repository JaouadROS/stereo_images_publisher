...
public:
    ...
    explicit images_sequence(const std::string& seq_dir_path, const std::string& img_left_folder_name, const std::string& img_right_folder_name);

    virtual ~images_sequence() = default;
